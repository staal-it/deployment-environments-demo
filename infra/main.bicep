...
module vnet 'core/networking/vnet.bicep' = {
  ...
  params: {
    location: location
    name: 'vnet-${devCenterConfig.orgName}-${resourceToken}'
  }
}

module devCenterConnection 'core/networking/connection.bicep' = {
  scope: rg
  name: 'devCenterConnection'
  params: {
    location: location
    name: 'net-conn-${devCenterConfig.orgName}-${resourceToken}'
...
module devcenter 'core/devcenter/devcenter.bicep' = {
  ...
  params: {
    ...
    networkConnectionId: devCenterConnection.outputs.id
  }
}
